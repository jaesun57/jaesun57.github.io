...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeSubItem{Physics Thesis:}
    {Kinetic MHD stability limit of Low-n mode in Negative triangularity Plasma}
    \resumeSubItem{Computer Science Thesis:}
    {Developing an IMAS-Compatible Database Platform for VEST and Its Application}
  \resumeItemListEnd
